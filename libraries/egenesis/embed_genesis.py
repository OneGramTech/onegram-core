...
from embed_genesis_lib import convert_to_c_array_parallel, replace_with_dictionary, read_file_data, \
    GENESIS_FILE_BANNER, GENESIS_ARRAY_WIDTH
...
if __name__ == '__main__':
    ...
    template_substitution = {
        ...
        b"genesis_json_array": convert_to_c_array_parallel(genesis_c_array),
